...
namespace phx
{
	...
	public:
		...
		/**
		 * @brief Fetches a pointer to the registered config file. nullptr if the file has not been registered yet.
		 ...
		 * @return A pointer to the ConfigFile of the specified name. nullptr if the config file has not been registered. 
		 */
