...
namespace qz
{
	namespace sdl
	{
		 ...
		 * 
		 */
		class SDLWindow : public qz::gfx::IWindow
		{
		public:
		  	/**
			...
			virtual void setCursorState(gfx::CursorState cursorState);
		...
		private:
			...
			{
				std::function<void(TVector2<int>, events::MouseAction, events::MouseButton)> callback;
			};
